  ...
  <el-dialog
    ...
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()"
      ...
      <el-form-item label="教材名称" prop="name">
        <el-input v-model="dataForm.name" placeholder="教材名称"></el-input>
      </el-form-item>
      ...
      init (id) {
        ...
        this.$nextTick(() => {
          ...
          if (!this.dataForm.materialId) {
            ...
            this.$http({
              url: this.$http.adornUrl(`/business/teachingmaterial/info/${this.dataForm.materialId}`),
              method: 'get',
              ...
              if (data && data.code === 0) {
                ...
                // 已加入项目成员的teacherId
                this.dataForm.personId = data.teachingMaterial.personId
                this.choiceDataList = data.teachingMaterial.memberIdList
                // 附件信息
                this.fileList = transferDataToFile(data.teachingMaterial.sysAttachEntityList)
                this.dataFormLoading = false
              } else {
                this.dataFormLoading = false
              }
      ...
      dataFormSubmit () {
        this.$refs['dataForm'].validate((valid) => {
          if (valid) {
            ...
            this.$http({
              url: this.$http.adornUrl(`/business/teachingmaterial/${!this.dataForm.materialId ? 'save' : 'update'}`),
              method: 'post',
