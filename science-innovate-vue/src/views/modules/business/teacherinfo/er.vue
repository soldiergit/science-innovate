  ...
  <div class="mod-config">
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
      ...
      <el-form-item>
        ...
        <el-button v-if="isAuth('business:teacherinfo:save')" type="primary" @click="addOrUpdateHandle()">新增</el-button>
        <el-upload
          class="upload-demo"
          ...
          <el-tooltip class="item" effect="dark" content="请下载模板再上传，且只能上传xls/xlsx文件" placement="top">
            <el-button type="info" icon="el-icon-upload2">导入教师信息</el-button>
          </el-tooltip>
        </el-upload>
        ...
        <el-button type="info" icon="el-icon-download" @click="downloadExcelTemplate()">下载模板</el-button>
    ...
    <el-table
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          ...
          <el-button type="text" size="small" @click="addOrUpdateHandle(scope.row.teacherId)">修改</el-button>
